...
const Gallery = () => {
    return (
        ...
        <div id='sm' className="flex justify-center md:hidden">
            <img className='w-[40vh] h-[30vh] sm:w-[50vh] sm:h-[35vh] object-cover rounded-xl' src={c3} alt="" />
        </div>
        <div id='md' className="hidden xl:flex xl:h-96 w-full">
            <img className='w-[20%] object-cover' src={l1} alt="" />
            <img className='w-[20%] object-cover' src={l2} alt="" />
            <img className='w-[20%] object-cover' src={l3} alt="" />
            <img className='w-[20%] object-cover' src={l4} alt="" />
            <img className='w-[20%] object-cover' src={l5} alt="" />
        </div>
        </>
    )
}
