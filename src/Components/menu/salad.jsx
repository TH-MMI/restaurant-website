const Salad = () => {
    return (
        <div className="flex w-[80%] justify-center items-center gap-20 pb-10 mt-10 flex-wrap">
             <img className='w-[60vh] h-[55vh] object-cover' src="https://www.bettybossi.ch/rdbimg/bb_scsc160101_0226a/bb_scsc160101_0226a_r01_v005_x0010.jpg" alt="" width='500' />
